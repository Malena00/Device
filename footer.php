<footer class="footer_container">
    <a href="/device/index.html" class="footer_logo">
        <svg width="145" height="37" viewBox="0 0 145 37" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <path
                ...
                fill="#FFC700" />
            <path d="M83.458 10.489H91.0633V35.689H83.458V10.489Z" fill="#FFC700" />
            <path
            ...
            <path
                ...
                fill="#FFC700" />
            <path d="M83.458 0.388916V10.4889L91.0633 0.388916H83.458Z" fill="#FFC700">
        </svg>
    </a>
    <div class="footer_address">
        <p class="footer_info">Санкт-Петербург, набережная реки Карповки, 5, литера П.</p>
    </div>
    <ul class="footer_menu">
        <li class="footer_menu-item">
            <a href="/device/index.html#extra-services" class="menu-item_link footer">Доставка</a>
        </li>
        <li class="footer_menu-item">
            <a href="/device/index.html#guarantee" class="menu-item_link footer">Гарантия</a>
        </li>
        <li class="footer_menu-item">
            <a href="/device/index.html#contacts" class="menu-item_link footer">Контакты</a>
        </li>
    </ul>
    <a href="tel:+78128121212" class="footer_contact-link footer_info">Тел.: +7 (812) 812-12-12</a>
    <div class="footer_yellow-line"></div>
    <div class="footer_social-media">
        <a href="" class="social-media">
            <img src="/device/img/facebook.png" alt="Facebook">
        </a>
        <a href="" class="social-media">
            <img src="/device/img/instagram.png" alt="Instagram">
        </a>
        <a href="" class="social-media">
            <img src="/device/img/twitter.png" alt="Twitter">
        </a>
    </div>
</footer>
<script src="/device/javascript/script.js?<?= time() ?>"></script>
<script src="/device/javascript/script_pagination.js?<?= time() ?>"></script>
</body>
